...
function App() {
  ...
  return (
          <div className={cn('w-full h-full relative flex flex-col gap-4')}>
            ...
            {/* Edit Warner */}
             {isEditMode &&            
              <div className='w-full text-edit font-secondary text-[12px] font-bold shadow-aura shadow-edit/20 bg-edit/10 border-2 border-edit/20 rounded-lg transition-all duration-400'>
                <div className={cn(
                        'text-edit font-secondary text-[12px] font-bold p-2 bg-edit/10  rounded-lg transition-all duration-400',
                  )}
                >
